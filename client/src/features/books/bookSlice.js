...
export const fetchLibraryStats = createAsyncThunk("books/fetchLibraryStats", async (_, { rejectWithValue }) => {
  try
  {
...
const bookSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchLibraryStats.pending, (state) => {
      ...
      .addCase(fetchLibraryStats.rejected, (state, action) => {
